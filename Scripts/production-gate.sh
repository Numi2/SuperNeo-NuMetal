...
run_step Scripts/validate-product-shared-bad-event-dedup.py
run_step Scripts/test-product-shared-bad-event-dedup-validation.py
...
run_step Scripts/validate-benchmark-coverage.py
