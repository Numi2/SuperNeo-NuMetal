...
def validate(path: Path) -> None:
    ...
    require(bounds.get("bindingTargetEventCount") == 9, "bindingTargetEventCount must be 9")
    require(bounds.get("bindingCollisionFormula") == "4 * bindingTargetEventCount * Q_H^2 / 2^bindingDigestBits", "binding formula mismatch")
    require(bounds.get("bindingCollisionInstantiatedExpression") == "4 * 9 * 2^128 / 2^384 = 36 * 2^-256", "binding expression mismatch")
